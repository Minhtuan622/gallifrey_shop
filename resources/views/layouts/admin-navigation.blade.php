<nav x-data="{ open: false }"
     class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-lg fixed w-full z-10">
            ...
            <x-dropdown align="left" width="48">
              ...
              <x-slot name="content">
                ...
                <x-dropdown-link :href="route('admin.banners.index')">
                  <i class="fas fa-users mr-2"></i> {{ __('Banners') }}
                </x-dropdown-link>
              </x-slot>
            </x-dropdown>
          </div>
      ...
      <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
        ...
        <div x-data="{ open: false }" class="relative">
          ...
          <div x-show="open" @click.away="open = false"
               class="origin-top-right absolute right-0 mt-2 w-64 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5">
  ...
  <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
    <div class="pt-2 pb-3 space-y-1">
      ...
      <x-responsive-nav-link :href="route('admin.banners.index')" :active="request()->routeIs('admin.banners.index')">
        <i class="fas fa-users mr-2"></i> {{ __('Manage Banners') }}
      </x-responsive-nav-link>
    </div>
